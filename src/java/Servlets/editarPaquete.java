 ...
 * @author topli_000
 */
@WebServlet(name = "editarPaquete", urlPatterns = {"/editarPaquete"})
 ...
 Double valor = 00.0;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet editarPaquete</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet editarPaquete at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         int codigo = Integer.parseInt(request.getParameter("codigo"));
          ...
          control.editarPaquete(pack);
                  
  valort = 00.0;
valort = 00.0;

   
            response.sendRedirect("VMPaquetes.jsp");    
