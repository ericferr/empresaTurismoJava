      ...
      <nav class="mt-2">
       ...
       <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="VMVentas.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Venta</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="VMReservas.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Reserva</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="VMPaquetes.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Paquete</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="VMServicios.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Servicios</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="VMClientes.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Clientes</p>
                </a>
              </li>
