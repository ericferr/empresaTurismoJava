...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="VBVentas" class="nav-link">Ventas</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="VBReservas" class="nav-link">Reservas</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="VBPaquetes" class="nav-link">Paquetes</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="VBServicios" class="nav-link">Servicios</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="VBClientes" class="nav-link">Clientes</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Soporte.jsp" class="nav-link">Soporte</a>
      </li>
       <li class="nav-item d-none d-sm-inline-block">
        <a href="index.jsp" class="nav-link">Cerrar Sesion</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Eric Ferreira</a>
        </div>
      </div>
