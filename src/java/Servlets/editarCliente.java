...
public class editarCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cli.setCelular(request.getParameter("tel"));
        
        cli.setDni(Integer.parseInt(request.getParameter("dni")));
        String nomapellido = request.getParameter("nom");
        cli.setNombreapellido(nomapellido);
        cli.setFechanac(ManejadorFechas.deStringToDate2(request.getParameter("fecha")));
        
        ControladoraPersistencia control = new ControladoraPersistencia();
        
        control.editarCliente(cli);
        
        response.sendRedirect("VMClientes.jsp");
